...
def get_model(num_users, num_items, mf_dim, layers, atten_prob):
    ...
    attention_probs = Dense(atten_prob, activation='softmax', name='attention_vec')(mlp_vector)
    mlp_vector = multiply([mlp_vector, attention_probs], name='attention_mul')
